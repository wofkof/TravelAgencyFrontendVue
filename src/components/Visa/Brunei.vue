<template>
  <div class="visa-info-container">
    <h3><el-icon><Avatar /></el-icon>汶萊簽證｜申辦項目</h3>

    <el-card class="visa-info-card">
      <el-row :gutter="2" align="middle">
        <el-col :span="5">
          <div class="item-title">3個月單次觀光</div>
        </el-col>

        <el-col :span="18">
          <el-row>
            <el-card class="item-info-card">
              <el-col :span="16">一般件：7個工作天</el-col>
              <el-col :span="12">效期：3個月</el-col>
              <el-col :span="12">停留時間 14天</el-col>

              <el-col :span="30" style="text-align: right;" styl="text-align: left;">

                <el-col :span="24" style="text-align: right;">TWD 1,300</el-col>
