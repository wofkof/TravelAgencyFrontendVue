<template>
  <div class="visa-info-container">
    <h3><el-icon><Avatar /></el-icon>阿拉伯聯合大公國簽證｜申辦項目</h3>
    <el-card class="visa-info-card">
      <el-row :gutter="2" align="middle">
        <el-col :span="5">
          <div class="item-title">觀光30天單次電子簽證</div>
        </el-col>
        <el-col :span="18">
          <el-row>
            <el-card class="item-info-card">
              <el-col :span="16">一般件：8個工作天</el-col>
              <el-col :span="12">效期：59天</el-col>
              <el-col :span="12">停留時間 29天</el-col>
              <el-col :span="30" style="text-align: right;" styl="text-align: left;">
                <el-col :span="24" style="text-align: right;">TWD 4,700</el-col>
