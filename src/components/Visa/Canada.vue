<template>
  <div class="visa-info-container">
    <h3><el-icon><Avatar /></el-icon>加拿大簽證｜申辦項目</h3>
    <el-card class="visa-info-card">
      <el-row :gutter="2" align="middle">
        <el-col :span="5">
          <div class="item-title">電子旅行許可證(eTA)</div>
        </el-col>
        <el-col :span="18">
          <el-row>
            <el-card class="item-info-card">
              ...
              <el-col :span="12">停留時間 6個月</el-col>
              <el-col :span="30" style="text-align: right;" styl="text-align: left;">
                <el-col :span="24" style="text-align: right;">TWD 900</el-col>
